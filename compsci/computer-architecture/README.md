...
> Hierarchy: Application Software (Programs) -> Operating Systems (Device Drivers) -> Architecture (Instructions, Registers) -> Micro-architecture (Datapaths, Controllers) -> Logic (Adresses, Memories) -> Digital Circuits (AND gates, NOT gates) -> Analog Circuits (Ampilifiers, Filters) -> Devices (Transistors, Diodes) -> Physics (Electrons)
